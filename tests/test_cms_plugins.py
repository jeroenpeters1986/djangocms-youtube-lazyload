...
class YoutubePluginTestCase(CMSTestCase):
    def setUp(self):
        super(YoutubePluginTestCase, self).setUp()
        ...
        self.video_plugin = add_plugin(self.placeholder, 'YoutubeLazyload', 'en', **plugin_data)
