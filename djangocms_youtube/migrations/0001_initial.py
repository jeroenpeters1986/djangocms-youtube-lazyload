    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.FileField(help_text='Image Overlay - this image will display over the video on your site and allow users to see an image of your choice before playing the video.', upload_to='djangocms_youtube', null=True, verbose_name='Custom Thumbnail', blank=True)),
                ...
                ('theme', models.CharField(default=b'light', max_length=100, verbose_name='Theme', choices=[(b'dark', 'Dark'), (b'light', 'Light')])),
                ('plugin_template', models.CharField(default=b'djangocms_youtube/default.html', max_length=255, verbose_name='Template', choices=[(b'djangocms_youtube/default.html', 'Default')])),
